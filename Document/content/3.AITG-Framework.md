...
---
In our framework we use prompt injections and prompt attacks to indentify the vulnerabilities. We define the following three kind of Input for an AI System:
...
The following are the list of tests to perform for each of the 4 cathegories of our AI Architecture Model analyzed on the sections above:


Here's your AI Testing Guide Framework fully reviewed and structured clearly, with an additional column labeled **"Domain(s)"**, specifying each test's coverage across the four domains you outlined:
...
Based on the Threat modeling performed in Chapter 2, we define a structured framework mapping the most critical Security, Privacy, RAI, and Trustworthy AI threats to concrete test cases.
